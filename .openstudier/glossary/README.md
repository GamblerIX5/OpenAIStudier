...
Use this folder for locale-specific translation guidance that supplements `.openstudier/agent/translator.md`.
...
- PR #12345: https://github.com/GamblerIX/OpenStudier/pull/12345

## Do Not Translate (Locale Additions)

- `OpenStudier` (preserve casing)
