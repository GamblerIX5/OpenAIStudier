...
- PR #10018: https://github.com/GamblerIX/OpenStudier/pull/10018
- PR #12935: https://github.com/GamblerIX/OpenStudier/pull/12935

## Do Not Translate (Locale Additions)

- `OpenStudier` (preserve casing in prose; keep `openstudier` only in commands, package names, paths, or code)
- `OpenStudier CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
