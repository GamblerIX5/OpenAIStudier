...
- PR #15835: https://github.com/GamblerIX/OpenStudier/pull/15835

## Do Not Translate (Locale Additions)

- `OpenStudier` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `openstudier` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `OpenStudier` in prose, `openstudier` only for exact technical identifiers
...
- Avoid changing `openstudier` to `OpenStudier` inside commands, URLs, package names, or code literals
