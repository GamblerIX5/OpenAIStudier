...
- PR #13942: https://github.com/GamblerIX/OpenStudier/pull/13942

## Do Not Translate (Locale Additions)

- `OpenStudier` (preserve casing in prose; keep `openstudier` only when it is part of commands, package names, paths, or code)
- `OpenStudier Zen`
- `OpenStudier CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `openstudier` in prose when referring to the product name; use `OpenStudier`
