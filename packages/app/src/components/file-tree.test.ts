...
beforeAll(async () => {
  ...
  mock.module("@openstudier/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openstudier/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openstudier/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openstudier/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
