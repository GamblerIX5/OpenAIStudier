export const dict = {
  ...
  "dialog.provider.openstudier.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.openstudier.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.openstudierGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OpenStudier",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OpenStudier-u.",
  ...
  "provider.connect.openstudierZen.line1":
    "OpenStudier Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.openstudierZen.visit.prefix": "Posjeti ",
  "provider.connect.openstudierZen.visit.link": "opencode.ai/zen",
  "provider.connect.openstudierZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OpenStudier-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OpenStudier-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u openstudier.json",
  ...
  "dialog.server.description": "Promijeni na koji se OpenStudier server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija OpenStudier-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OpenStudier timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (openstudier.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OpenStudier još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OpenStudier uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OpenStudier server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OpenStudier-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako OpenStudier izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OpenStudier prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OpenStudier-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OpenStudier pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OpenStudier-a.",
