export const dict = {
  ...
  "dialog.provider.openstudier.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.openstudier.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.openstudierGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OpenStudier",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i OpenStudier.",
  ...
  "provider.connect.openstudierZen.line1":
    "OpenStudier Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.openstudierZen.visit.prefix": "Besøg ",
  "provider.connect.openstudierZen.visit.link": "opencode.ai/zen",
  "provider.connect.openstudierZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i OpenStudier.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i OpenStudier.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i openstudier.json",
  ...
  "dialog.server.description": "Skift hvilken OpenStudier-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af OpenStudier ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OpenStudier-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (openstudier.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OpenStudier understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OpenStudier inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør OpenStudier-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OpenStudier",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan OpenStudier ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om OpenStudier følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan OpenStudier er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OpenStudier starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OpenStudier.",
