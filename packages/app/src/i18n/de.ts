...
export const dict = {
  ...
  "dialog.provider.openstudier.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.openstudier.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.openstudierGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von OpenStudier",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OpenStudier zu nutzen.",
  ...
  "provider.connect.openstudierZen.line1":
    "OpenStudier Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.openstudierZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.openstudierZen.visit.link": "opencode.ai/zen",
  "provider.connect.openstudierZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in OpenStudier zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OpenStudier zu nutzen.",
  ...
  "dialog.plugins.empty": "In openstudier.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den OpenStudier-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von OpenStudier ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem OpenStudier-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (openstudier.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: OpenStudier unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "OpenStudier enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "OpenStudier-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OpenStudier ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie OpenStudier auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob OpenStudier dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von OpenStudier anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OpenStudier automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von OpenStudier.",
