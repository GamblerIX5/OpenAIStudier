export const dict = {
  ...
  "dialog.provider.openstudier.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.openstudier.tagline": "Modèles optimisés et fiables",
  "dialog.provider.openstudierGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par OpenStudier",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OpenStudier.",
  ...
  "provider.connect.openstudierZen.line1":
    "OpenStudier Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  "provider.connect.openstudierZen.line2":
    "Avec une seule clé API, vous aurez accès à des modèles tels que Claude, GPT, Gemini, GLM et plus encore.",
  "provider.connect.openstudierZen.visit.prefix": "Visitez ",
  "provider.connect.openstudierZen.visit.link": "opencode.ai/zen",
  "provider.connect.openstudierZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OpenStudier.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OpenStudier.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans openstudier.json",
  ...
  "dialog.server.description": "Changez le serveur OpenStudier auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'OpenStudier ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe OpenStudier",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (openstudier.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'OpenStudier ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "OpenStudier inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "OpenStudier Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur OpenStudier dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour OpenStudier",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'OpenStudier sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si OpenStudier suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'OpenStudier.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'OpenStudier",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'OpenStudier.",
