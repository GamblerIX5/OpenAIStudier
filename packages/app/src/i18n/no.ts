...
export const dict = {
  ...
  "dialog.provider.openstudier.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.openstudier.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.openstudierGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OpenStudier",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i OpenStudier.",
  ...
  "provider.connect.openstudierZen.line1":
    "OpenStudier Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.openstudierZen.visit.prefix": "Besøk ",
  "provider.connect.openstudierZen.visit.link": "opencode.ai/zen",
  "provider.connect.openstudierZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OpenStudier.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OpenStudier.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i openstudier.json",
  ...
  "dialog.server.description": "Bytt hvilken OpenStudier-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OpenStudier ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OpenStudier-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (openstudier.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OpenStudier ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OpenStudier inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør OpenStudier-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OpenStudier",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OpenStudier ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om OpenStudier skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan OpenStudier er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OpenStudier starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OpenStudier.",
