export const dict = {
  ...
  "dialog.provider.openstudier.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.openstudier.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.openstudierGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenStudier",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenStudier.",
  ...
  "provider.connect.openstudierZen.line1":
    "OpenStudier Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.openstudierZen.visit.prefix": "Odwiedź ",
  "provider.connect.openstudierZen.visit.link": "opencode.ai/zen",
  "provider.connect.openstudierZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenStudier.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenStudier.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w openstudier.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenStudier, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja OpenStudier ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenStudier",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (openstudier.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "OpenStudier zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenStudier",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenStudier na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenStudier ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenStudier.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenStudier",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenStudier.",
