...
export const dict = {
  ...
  "dialog.provider.openstudier.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.openstudier.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.openstudierGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenStudier tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OpenStudier'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.openstudierZen.line1":
    "OpenStudier Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.openstudierZen.visit.prefix": "",
  "provider.connect.openstudierZen.visit.link": "opencode.ai/zen",
  "provider.connect.openstudierZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve OpenStudier'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OpenStudier'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler openstudier.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OpenStudier sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "OpenStudier'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OpenStudier ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (openstudier.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: OpenStudier henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "OpenStudier ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "OpenStudier Masaüstü",
  ...
  "settings.desktop.wsl.description": "OpenStudier sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "OpenStudier'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "OpenStudier'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OpenStudier'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OpenStudier'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OpenStudier başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OpenStudier'un en son sürümünü kullanıyorsunuz.",
