import type { Message, Session, TextPart, UserMessage } from "@openstudier/sdk/v2/client"
import { Avatar } from "@openstudier/ui/avatar"
import { HoverCard } from "@openstudier/ui/hover-card"
...
const OPENSTUDIER_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === OPENSTUDIER_PROJECT_ID ? "https://opencode.ai/favicon.svg" : props.project.icon?.override
          }
