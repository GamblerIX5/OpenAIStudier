...
export const dict = {
  ...
  "notFound.title": "No encontrado | openstudier",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "openstudier logo claro",
  "notFound.logoDarkAlt": "openstudier logo oscuro",
  ...
  "app.meta.description": "OpenStudier - El agente de codificación de código abierto.",

  "home.title": "OpenStudier | El agente de codificación IA de código abierto",

  "temp.title": "openstudier | Agente de codificación IA creado para la terminal",
  "temp.hero.title": "El agente de codificación IA creado para la terminal",
  "temp.zen": "openstudier zen",
  ...
  "temp.feature.zen.afterLink": "proporcionada por openstudier",
  ...
  "temp.screenshot.caption": "openstudier TUI con el tema tokyonight",
  "temp.screenshot.alt": "openstudier TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de openstudier claro",
  "temp.logoDarkAlt": "logo de openstudier oscuro",
  ...
  "home.what.title": "¿Qué es OpenStudier?",
  "home.what.body":
    "OpenStudier es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, OpenStudier es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "OpenStudier no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es OpenStudier?",
  "home.faq.a1":
    "OpenStudier es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso OpenStudier?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar OpenStudier?",
  "home.faq.a3.p1":
    "No necesariamente, OpenStudier viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, OpenStudier también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con OpenStudier?",
  "home.faq.a4.p1":
    "Sí, OpenStudier soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar OpenStudier en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! OpenStudier ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta OpenStudier?",
  "home.faq.a6":
    "OpenStudier es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es OpenStudier de código abierto?",
  "home.faq.a8.p1": "Sí, OpenStudier es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que OpenStudier ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "OpenStudier Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que OpenStudier ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es OpenStudier Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de OpenStudier.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá OpenStudier negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, OpenStudier añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con OpenStudier, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de OpenStudier.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con OpenStudier, puedes usar Zen con cualquier agente.",
  ...
  "go.title": "OpenStudier Go | Modelos de programación de bajo coste para todos",
  "go.meta.description":
  ...
  "go.testimonials.handle": "@OpenStudier",
  ...
  "go.problem.body":
    "Nos enfocamos en llevar la experiencia de OpenStudier a tantas personas como sea posible. OpenStudier Go es una suscripción de bajo coste: $5 el primer mes, luego 10 $/mes. Proporciona límites generosos y acceso fiable a los modelos de código abierto más capaces.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go comienza en $5 el primer mes, luego 10 $/mes. Puedes usarlo con OpenStudier o cualquier agente.",
  ...
  "go.faq.q1": "¿Qué es OpenStudier Go?",
  "go.faq.a1":
  ...
  "black.meta.title": "OpenStudier Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de OpenStudier Black.",
  ...
  "black.title": "OpenStudier Black | Precios",
  ...
  "black.workspace.title": "OpenStudier Black | Seleccionar Espacio de Trabajo",
  "black.workspace.selectPlan": "Selecciona un espacio de trabajo para este plan",
  "black.workspace.name": "Espacio de trabajo {{n}}",
  "black.subscribe.title": "Suscribirse a OpenStudier Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de OpenStudier Black",
  "black.subscribe.success.subscriptionPlan": "Plan de suscripción",
  "black.subscribe.success.planName": "OpenStudier Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con openstudier cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona openstudier",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia openstudier y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de openstudier.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de openstudier Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a OpenStudier Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan OpenStudier Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan OpenStudier Black de ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.message": "Estás suscrito a OpenStudier Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "OpenStudier Go" como proveedor en tu configuración de openstudier para usar los modelos Go.',
  "workspace.lite.black.message":
    "Actualmente estás suscrito a OpenStudier Black o estás en la lista de espera. Por favor, cancela la suscripción primero si deseas cambiar a Go.",
  "workspace.lite.other.message":
    "Otro miembro de este espacio de trabajo ya está suscrito a OpenStudier Go. Solo un miembro por espacio de trabajo puede suscribirse.",
  "workspace.lite.promo.description":
    "OpenStudier Go comienza en {{price}}, luego $10/mes, y ofrece acceso confiable a modelos de codificación abiertos populares con límites de uso generosos.",
  ...
  "download.title": "OpenStudier | Descargar",
  "download.meta.description": "Descarga OpenStudier para macOS, Windows y Linux",
  "download.hero.title": "Descargar OpenStudier",
  "download.hero.subtitle": "Disponible en Beta para macOS, Windows y Linux",
  "download.hero.button": "Descargar para {{os}}",
  "download.section.terminal": "OpenStudier Terminal",
  "download.section.desktop": "OpenStudier Desktop (Beta)",
  "download.section.extensions": "Extensiones OpenStudier",
  "download.section.integrations": "Integraciones OpenStudier",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar OpenStudier a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", OpenStudier funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "OpenStudier es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque OpenStudier funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en OpenStudier.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "OpenStudier | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a OpenStudier para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "OpenStudier opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es OpenStudier Enterprise?",
  "enterprise.faq.a1":
    "OpenStudier Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con OpenStudier Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. OpenStudier por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con OpenStudier Enterprise?",
  "enterprise.faq.a4":
    "Sí. OpenStudier no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "OpenStudier | Marca",
  "brand.meta.description": "Guías de marca de OpenStudier",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca OpenStudier.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "OpenStudier | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de OpenStudier",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para OpenStudier",
