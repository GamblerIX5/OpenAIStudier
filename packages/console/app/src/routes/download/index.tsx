...
import desktopAppIcon from "../../asset/lander/openstudier-desktop-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g openstudier")}>
                <code>
                  npm i -g <strong>openstudier</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g openstudier")}>
                <code>
                  bun add -g <strong>openstudier</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/openstudier")}>
                <code>
                  brew install <strong>anomalyco/tap/openstudier</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S openstudier")}>
                <code>
                  paru -S <strong>openstudier</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask openstudier-desktop")}>
                <code>
                  brew install --cask <strong>openstudier-desktop</strong>
                </code>
                <CopyStatus />
              </button>
