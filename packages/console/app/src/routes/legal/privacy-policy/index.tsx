...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>OpenStudier | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="OpenStudier privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At OpenStudier, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of OpenStudier is at all times subject to our Terms of Use,{" "}
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the OpenStudier website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about OpenStudier.
                </li>
              ...
              <p>
                ...
                you, OpenStudier or another party; enforcing any agreements with you; responding to claims that any posting
