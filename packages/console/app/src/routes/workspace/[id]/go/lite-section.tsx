...
import { Database, eq, and, isNull } from "@openstudier/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@openstudier/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#openstudier-go")} target="_blank" rel="noopener noreferrer">
