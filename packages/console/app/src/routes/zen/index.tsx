...
import compareVideo from "../../asset/lander/openstudier-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/openstudier-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="openstudier:auth" content={loggedin() ? "true" : "false"} />
