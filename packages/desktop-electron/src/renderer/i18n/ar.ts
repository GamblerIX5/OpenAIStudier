export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من OpenStudier",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من OpenStudier، هل ترغب في تثبيته وإعادة تشغيله؟",
