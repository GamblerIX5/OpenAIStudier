...
const releaseId = process.env.OPENSTUDIER_RELEASE
if (!releaseId) throw new Error("OPENSTUDIER_RELEASE is required")

const version = process.env.OPENSTUDIER_VERSION
if (!releaseId) throw new Error("OPENSTUDIER_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "openstudier-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "openstudier-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "openstudier-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "openstudier-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "openstudier-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "openstudier-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "openstudier-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "openstudier-desktop-darwin-aarch64.app.tar.gz",
  },
]
