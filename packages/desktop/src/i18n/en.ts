export const dict = {
  ...
  "desktop.menu.help.documentation": "OpenStudier Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "OpenStudier CLI binary is missing. Try reinstalling the desktop app.",
