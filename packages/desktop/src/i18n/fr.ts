export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentation d'OpenStudier",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI OpenStudier est manquant. Essayez de réinstaller l'application de bureau.",
