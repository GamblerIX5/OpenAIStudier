export const dict = {
  ...
  "desktop.menu.help.documentation": "OpenStudier Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "OpenStudier CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
