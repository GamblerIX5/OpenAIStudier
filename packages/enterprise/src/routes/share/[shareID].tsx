import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@openstudier/sdk/v2"
import { SessionTurn } from "@openstudier/ui/session-turn"
import { SessionReview } from "@openstudier/ui/session-review"
import { DataProvider } from "@openstudier/ui/context"
import { FileComponentProvider } from "@openstudier/ui/context/file"
import { WorkerPoolProvider } from "@openstudier/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@openstudier/ui/logo"
import { IconButton } from "@openstudier/ui/icon-button"
import { ProviderIcon } from "@openstudier/ui/provider-icon"
import { iife } from "@openstudier/util/iife"
import { Binary } from "@openstudier/util/binary"
import { NamedError } from "@openstudier/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@openstudier/ui/tabs"
import { MessageNav } from "@openstudier/ui/message-nav"
import { FileSSR } from "@openstudier/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@openstudier/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/openstudier-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | OpenStudier</Title>
              </Show>
              <Meta name="description" content="openstudier - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/GamblerIX/OpenStudier"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
