...
export const OAUTH_DUMMY_KEY = "openstudier-oauth-dummy-key"
...
export class AuthService extends ServiceMap.Service<AuthService, AuthService.Service>()("@openstudier/Auth") {
