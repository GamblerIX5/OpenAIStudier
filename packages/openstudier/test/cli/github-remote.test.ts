...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openstudier.git")).toEqual({ owner: "sst", repo: "openstudier" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openstudier")).toEqual({ owner: "sst", repo: "openstudier" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openstudier.git")).toEqual({ owner: "sst", repo: "openstudier" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openstudier")).toEqual({ owner: "sst", repo: "openstudier" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openstudier.git")).toEqual({ owner: "sst", repo: "openstudier" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openstudier")).toEqual({ owner: "sst", repo: "openstudier" })
})
