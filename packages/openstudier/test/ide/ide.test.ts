...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENSTUDIER_CALLER", () => {
    process.env["OPENSTUDIER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENSTUDIER_CALLER", () => {
    process.env["OPENSTUDIER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENSTUDIER_CALLER", () => {
    process.env["OPENSTUDIER_CALLER"] = "unknown"
