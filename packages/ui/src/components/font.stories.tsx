...
const docs = `### Overview
Loads OpenStudier typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>OpenStudier Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>OpenStudier Mono Sample</div>
    </div>
  ),
}
