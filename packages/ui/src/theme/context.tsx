...
const STORAGE_KEYS = {
  THEME_ID: "openstudier-theme-id",
  COLOR_SCHEME: "openstudier-color-scheme",
  THEME_CSS_LIGHT: "openstudier-theme-css-light",
  THEME_CSS_DARK: "openstudier-theme-css-dark",
} as const
