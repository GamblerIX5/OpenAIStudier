...
import type { MessageV2 } from "openstudier/session/message-v2"
import type { Message } from "openstudier/session/message"
import type { Session } from "openstudier/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.openstudier_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.openstudier_name}>
