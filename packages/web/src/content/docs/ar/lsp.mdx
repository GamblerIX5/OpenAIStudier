---
title: خوادم LSP
description: يتكامل OpenStudier مع خوادم LSP لديك.
---

يتكامل OpenStudier مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي OpenStudier مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `OPENSTUDIER_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عندما يفتح openstudier ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات openstudier.
