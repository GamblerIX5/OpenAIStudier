---
title: TUI
description: استخدام واجهة المستخدم TUI في OpenStudier.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر OpenStudier واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل OpenStudier إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة OpenStudier في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى OpenStudier. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من OpenStudier. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات OpenStudier.
...
استخدم `OPENSTUDIER_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
