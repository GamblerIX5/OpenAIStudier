---
title: Zen
description: قائمة منتقاة من النماذج يوفّرها OpenStudier.
---
...
OpenStudier Zen هي قائمة بالنماذج التي اختبرها فريق OpenStudier وتحقّق منها.

:::note
OpenStudier Zen متاح حاليا بنسخة تجريبية.
:::

يعمل Zen مثل أي مزوّد آخر في OpenStudier. تسجّل الدخول إلى OpenStudier Zen وتحصل على
مفتاح API. استخدامه **اختياري بالكامل** ولا تحتاج إليه لاستخدام OpenStudier.
...
:::tip
اختبرنا مجموعة منتقاة من النماذج والمزوّدين الذين يعملون جيدا مع OpenStudier.
:::
...
OpenStudier Zen هو بوابة للذكاء الاصطناعي تتيح لك الوصول إلى هذه النماذج.

---

## كيف يعمل

يعمل OpenStudier Zen مثل أي مزوّد آخر في OpenStudier.

1. تسجّل الدخول إلى **<a href={console}>OpenStudier Zen</a>**، وتضيف تفاصيل الفوترة، ثم تنسخ مفتاح API.
2. تشغّل الأمر `/connect` في واجهة TUI، وتختار OpenStudier Zen، ثم تلصق مفتاح API.
...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات OpenStudier الصيغة `openstudier/<model-id>`.
على سبيل المثال، بالنسبة إلى GPT 5.2 Codex ستستخدم `openstudier/gpt-5.2-codex` في إعداداتك.
...
- MiniMax M2.5 Free متاح على OpenStudier لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Big Pickle نموذج خفي ومتاح مجانا على OpenStudier لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
...
4. عدم فرض **أي ارتباط حصري (lock-in)** عبر تمكينك من استخدامه مع أي عامل برمجة آخر، مع إتاحة استخدام أي مزوّد آخر مع OpenStudier أيضا.
