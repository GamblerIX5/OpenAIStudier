...
Kreiraj `.openstudier/commands/test.md`:
...
Možete dodati prilagođene komande kroz OpenStudier konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OpenStudier [config](/docs/config):
...
- Globalno: `~/.config/openstudier/commands/`
- Po projektu: `.openstudier/commands/`
...
OpenStudier uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
