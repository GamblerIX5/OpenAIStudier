---
title: TUI
description: Korištenje korisničkog interfejsa OpenStudier terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenStudier pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OpenStudier pokreće TUI za trenutni direktorij.
...
Kada koristite OpenStudier TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OpenStudier. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OpenStudier. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `openstudier.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `OPENSTUDIER_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
