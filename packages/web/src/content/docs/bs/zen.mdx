---
title: Zen
description: Kurirana lista modela koje nudi OpenStudier.
---
...
OpenStudier Zen je lista testiranih i provjerenih modela koje obezbjeduje OpenStudier tim.

:::note
OpenStudier Zen je trenutno u beta fazi.
:::

Zen radi kao i svaki drugi provajder u OpenStudier. Prijavite se u OpenStudier Zen i uzmete API kljuc. Ovo je **potpuno opcionalno** i ne morate ga koristiti da biste koristili OpenStudier.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s OpenStudier.
:::
...
OpenStudier Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

OpenStudier Zen radi kao i svaki drugi provajder u OpenStudier.

1. Prijavite se na **<a href={console}>OpenStudier Zen</a>**, dodajte billing podatke i kopirajte API kljuc.
2. U TUI-ju pokrenite `/connect`, izaberite OpenStudier Zen i zalijepite API kljuc.
...
[model id](/docs/config/#models) u OpenStudier konfiguraciji koristi format `openstudier/<model-id>`. Na primjer, za GPT 5.2 Codex u konfiguraciji koristite `openstudier/gpt-5.2-codex`.
...
- MiniMax M2.5 Free je dostupan na OpenStudier ograniceno vrijeme. Tim koristi taj period za prikupljanje povratnih informacija i poboljsanje modela.
- Big Pickle je stealth model koji je besplatan na OpenStudier ograniceno vrijeme. Tim koristi taj period za prikupljanje povratnih informacija i poboljsanje modela.
...
OpenStudier Zen smo napravili da:
...
4. Obezbijedimo **bez lock-ina** tako da Zen mozete koristiti sa bilo kojim coding agentom, uz slobodu koristenja drugih provajdera u OpenStudier.
