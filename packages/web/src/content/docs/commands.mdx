...
Create `.openstudier/commands/test.md`:
...
You can add custom commands through the OpenStudier config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your OpenStudier [config](/docs/config):
...
- Per-project: `.openstudier/commands/`
...
openstudier includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
