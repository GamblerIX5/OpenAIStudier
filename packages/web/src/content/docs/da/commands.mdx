...
Opret `.openstudier/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem OpenStudier-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din OpenStudier [config](/docs/config):
...
- Globalt: `~/.config/openstudier/commands/`
- Pr. projekt: `.openstudier/commands/`
...
openstudier indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
