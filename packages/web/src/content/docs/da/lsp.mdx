---
title: LSP-servere
description: OpenStudier integreres med dine LSP-servere.
---

OpenStudier integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

OpenStudier leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OPENSTUDIER_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når openstudier åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din openstudier-konfiguration.
