...
Brug den til at bygge integrasjoner og kontrollere openstudier programmatisk.
...
Opret en forekomst av openstudier:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `openstudier.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av openstudier, kan du oprete en klientforekomst for at koble til den:
