---
title: TUI
description: Brug af OpenStudier-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenStudier giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre OpenStudier starter TUI for den nuværende mappe.
...
Når du bruger OpenStudier TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til OpenStudier. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut OpenStudier. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `openstudier.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `OPENSTUDIER_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
