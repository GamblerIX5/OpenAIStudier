---
title: Zen
description: Udvalgt liste over modeller leveret af OpenStudier.
---
...
OpenStudier Zen er en liste over testede og verificerede modeller leveret af OpenStudier-teamet.

:::note
OpenStudier Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i OpenStudier. Du logger på OpenStudier Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med OpenStudier.
:::
...
OpenStudier Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

OpenStudier Zen fungerer som alle andre udbydere i OpenStudier.

1. Du logger på **<a href={console}>OpenStudier Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger OpenStudier Zen og indsætter API-nøglen.
...
[model-id](/docs/config/#models) i OpenStudier-konfigurationen
bruger formatet `openstudier/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `openstudier/gpt-5.2-codex` i din konfiguration.
...
- MiniMax M2.5 Gratis er tilgængelig på OpenStudier i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på OpenStudier i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede OpenStudier Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med OpenStudier også.
