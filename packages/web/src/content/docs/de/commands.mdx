...
Erstellen Sie `.openstudier/commands/test.md`:

```md title=".openstudier/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die OpenStudier-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem OpenStudier [config](/docs/config):

```json title="openstudier.jsonc" {4-12}
{
...
- Global: `~/.config/openstudier/commands/`
- Pro Projekt: `.openstudier/commands/`

```markdown title="~/.config/openstudier/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".openstudier/commands/component.md"
---
...
```md title=".openstudier/commands/create-file.md"
---
...
```md title=".openstudier/commands/analyze-coverage.md"
---
...
```md title=".openstudier/commands/review-changes.md"
---
...
```md title=".openstudier/commands/review-component.md"
---
...
OpenStudier enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
