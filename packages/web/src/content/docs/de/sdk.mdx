---
title: SDK
description: Typsicherer JS-Client fuer den openstudier-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das openstudier JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und openstudier programmatisch steuern.
...
Erstelle eine openstudier-Instanz:
...
`openstudier.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn openstudier bereits laeuft, kannst du nur einen Client erstellen und verbinden:
