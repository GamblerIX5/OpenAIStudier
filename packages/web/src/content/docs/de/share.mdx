---
title: Teilen
description: Teile OpenStudier-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OpenStudier-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OpenStudier Folgendes:
...
OpenStudier hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OpenStudier den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`openstudier.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du openstudier in deiner Organisation einsetzt.
