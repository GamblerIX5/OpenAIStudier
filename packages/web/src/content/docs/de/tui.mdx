---
title: TUI
description: Arbeite mit OpenStudier in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenStudier bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet OpenStudier die TUI im aktuellen Verzeichnis.
...
In der OpenStudier-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu OpenStudier hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet OpenStudier. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `openstudier.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `OPENSTUDIER_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
