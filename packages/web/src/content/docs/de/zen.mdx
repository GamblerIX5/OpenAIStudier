---
title: Zen
description: Kuratierte Modellliste direkt von OpenStudier.
---
...
OpenStudier Zen ist eine vom OpenStudier-Team getestete und verifizierte Modellliste.

:::note
OpenStudier Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in OpenStudier.
Du meldest dich bei OpenStudier Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit OpenStudier funktionieren.
:::
...
OpenStudier Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

OpenStudier Zen funktioniert wie jeder andere Provider in OpenStudier.

1. Melde dich bei **<a href={console}>OpenStudier Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle OpenStudier Zen und fuege den API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner OpenStudier-Konfiguration hat das Format `openstudier/<model-id>`.
Fuer GPT 5.2 Codex verwendest du zum Beispiel `openstudier/gpt-5.2-codex`.
...
- MiniMax M2.5 Free ist fuer begrenzte Zeit auf OpenStudier verfuegbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das fuer begrenzte Zeit kostenlos auf OpenStudier verfuegbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben OpenStudier Zen entwickelt, um:
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und OpenStudier weiter mit anderen Providern nutzen kannst
