...
Crear `.openstudier/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración OpenStudier o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su OpenStudier [config](/docs/config):
...
- Por proyecto: `.openstudier/commands/`
...
openstudier incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
