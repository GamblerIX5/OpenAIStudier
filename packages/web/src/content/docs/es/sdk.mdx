---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor openstudier.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El SDK openstudier JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar openstudier mediante programación.
...
Cree una instancia de openstudier:
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `openstudier.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de openstudier, puede crear una instancia de cliente para conectarse a ella:
