...
Con OpenStudier puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, OpenStudier usa nuestro propio tema `openstudier`.
...
OpenStudier viene con varios temas integrados.
...
- Quiere que OpenStudier coincida con la apariencia de su terminal
...
OpenStudier admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/openstudier/themes/*.json` o `$XDG_CONFIG_HOME/openstudier/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.openstudier/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.openstudier/themes/*.json`
