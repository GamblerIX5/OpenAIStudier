---
title: TUI
description: Usando la interfaz de usuario del terminal OpenStudier.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenStudier proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar OpenStudier se inicia TUI para el directorio actual.
...
Cuando utilice OpenStudier TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a OpenStudier. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de OpenStudier. _Alias_: `/quit`, `/q`
...
Esto es independiente de `openstudier.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `OPENSTUDIER_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
