...
Crea `.openstudier/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di OpenStudier o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di OpenStudier:
...
- Globale: `~/.config/openstudier/commands/`
- Per progetto: `.openstudier/commands/`
...
openstudier include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
