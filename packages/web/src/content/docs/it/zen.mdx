---
title: Zen
description: Lista curata di modelli fornita da OpenStudier.
---
...
OpenStudier Zen è una lista di modelli testati e verificati dal team di OpenStudier.

:::note
OpenStudier Zen è attualmente in beta.
:::

Zen funziona come qualunque altro provider in OpenStudier. Accedi a OpenStudier Zen e ottieni la tua chiave API. È **completamente opzionale**: non devi usarlo per usare OpenStudier.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con OpenStudier.
:::
...
OpenStudier Zen e un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

OpenStudier Zen funziona come qualunque altro provider in OpenStudier.

1. Accedi a **<a href={console}>OpenStudier Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona OpenStudier Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di OpenStudier usa il formato `openstudier/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `openstudier/gpt-5.2-codex` nella config.
...
- MiniMax M2.5 Free e disponibile su OpenStudier per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth gratuito su OpenStudier per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato OpenStudier Zen per:
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con OpenStudier.
