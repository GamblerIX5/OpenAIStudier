...
Opprett `.openstudier/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom OpenStudier-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i OpenStudier [config](/docs/config):
...
- Per prosjekt: `.openstudier/commands/`
...
OpenStudier inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
