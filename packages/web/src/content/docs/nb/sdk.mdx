---
title: SDK
description: Typesikker JS-klient for OpenStudier-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

OpenStudier JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere OpenStudier programmatisk.
...
Opprett en forekomst av OpenStudier:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `openstudier.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av OpenStudier, kan du opprette en klientforekomst for å koble til den:
