...
Agentferdigheter lar OpenStudier oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går openstudier opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
openstudier viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `openstudier.json`:
