---
title: TUI
description: Bruke openstudier-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenStudier gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre OpenStudier starter TUI for gjeldende katalog.
...
Når du bruker OpenStudier TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til OpenStudier. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt OpenStudier. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `openstudier.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `OPENSTUDIER_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
