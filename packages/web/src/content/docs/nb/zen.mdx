---
title: Zen
description: Utvalgt liste over modeller levert av OpenStudier.
---
...
OpenStudier Zen er en liste over testede og verifiserte modeller levert av OpenStudier-teamet.

:::note
OpenStudier Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i OpenStudier. Du logger på OpenStudier Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med OpenStudier.
:::
...
OpenStudier Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

OpenStudier Zen fungerer som alle andre leverandører i OpenStudier.

1. Du logger på **<a href={console}>OpenStudier Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger OpenStudier Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i OpenStudier-konfigurasjonen
bruker formatet `openstudier/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `openstudier/gpt-5.2-codex` i konfigurasjonen din.
...
- MiniMax M2.5 Free er tilgjengelig på OpenStudier i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på OpenStudier i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
Vi opprettet OpenStudier Zen for å:
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med OpenStudier også.
