...
Utwórz `.openstudier/commands/test.md`:
...
Możesz zdefiniować polecenia w `openstudier.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji openstudier:
...
- Globalnie: `~/.config/openstudier/commands/`
- Na projekt: `.openstudier/commands/`
...
openstudier zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
