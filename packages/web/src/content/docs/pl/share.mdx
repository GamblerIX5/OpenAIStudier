---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące openstudier.
---

Funkcja udostępniania openstudier umożliwia tworzenie publicznych linków do konwersacji openstudier, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, openstudier:
...
openstudier obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie openstudier korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `openstudier.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu openstudier w Twojej organizacji.
