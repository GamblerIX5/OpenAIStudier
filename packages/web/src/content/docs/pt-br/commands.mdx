...
Crie `.openstudier/commands/test.md`:
...
Você pode adicionar comandos personalizados através da configuração do openstudier ou criando arquivos markdown no diretório `commands/`.

---

### JSON

Use a opção `command` na sua [configuração](/docs/config) do openstudier:
...
- Por projeto: `.openstudier/commands/`
...
openstudier inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
