---
title: TUI
description: Usando a interface de usuário de terminal openstudier.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O openstudier fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar openstudier inicia o TUI para o diretório atual.
...
Ao usar o TUI do openstudier, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao openstudier. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do openstudier. _Aliases_: `/quit`, `/q`
...
Isso é separado do `openstudier.json`, que configura o comportamento do servidor/runtime.
...
Use `OPENSTUDIER_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
