---
title: Zen
description: Lista selecionada de modelos fornecidos pelo OpenStudier.
---
...
O OpenStudier Zen é uma lista de modelos testados e verificados fornecidos pela equipe do OpenStudier.

:::note
O OpenStudier Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no OpenStudier. Você faz login no OpenStudier Zen e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o OpenStudier.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o OpenStudier.
:::
...
O OpenStudier Zen é um gateway de IA que lhe dá acesso a esses modelos.

---

## Como funciona

O OpenStudier Zen funciona como qualquer outro provedor no OpenStudier.

1. Você faz login no **<a href={console}>OpenStudier Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona OpenStudier Zen e cola sua chave de API.
...
O [id do modelo](/docs/config/#models) na sua configuração do OpenStudier usa o formato `openstudier/<model-id>`. Por exemplo, para GPT 5.2 Codex, você usaria `openstudier/gpt-5.2-codex` na sua configuração.
...
- MiniMax M2.5 Free está disponível no OpenStudier por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo oculto que está gratuito no OpenStudier por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
...
Criamos o OpenStudier Zen para:
...
4. Não ter **vinculação** permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o OpenStudier também.
