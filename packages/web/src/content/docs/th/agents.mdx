...
OpenStudier มีเอเจนต์สองประเภท: **Primary Agent** (เอเจนต์หลัก) และ **Subagent** (เอเจนต์ย่อย)
...
OpenStudier มีเอเจนต์หลักในตัวได้แก่ **Build** และ **Plan**
...
OpenStudier มี subagent ในตัวได้แก่ **General** และ **Explore**

---

## บิวท์อิน

OpenStudier มาพร้อมกับเอเจนต์หลักและ subagent ในตัวดังนี้
...
กำหนดค่าเอเจนต์ในไฟล์ `openstudier.json` ของคุณ:
...
- ระดับผู้ใช้ (Global): `~/.config/openstudier/agents/`
- ระดับโปรเจ็กต์: `.openstudier/agents/`
...
หมายเหตุ: OpenStudier ค่าเริ่มต้นคือ 0 สำหรับโมเดลส่วนใหญ่ และ 0.55 สำหรับโมเดล Qwen
...
:::tip
หากไม่ได้ระบุโมเดล เอเจนต์จะใช้ [โมเดลเริ่มต้น](/docs/config#models) ของ OpenStudier
:::
...
:::tip
ใช้ `openstudier models` เพื่อดูรายการตัวเลือกทั้งหมด
:::
...
:::tip
คุณมีเอเจนต์เจ๋งๆ ที่ต้องการแบ่งปันหรือไม่? [ส่ง PR มาที่นี่](https://github.com/GamblerIX/OpenStudier)
:::
