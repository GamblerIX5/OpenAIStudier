...
สร้าง `.openstudier/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OpenStudier:
...
- ระดับผู้ใช้ (Global): `~/.config/openstudier/commands/`
- ระดับโปรเจ็กต์: `.openstudier/commands/`
...
OpenStudier มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
