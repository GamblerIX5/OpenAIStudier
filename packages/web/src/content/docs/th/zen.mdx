---
title: เซน
description: รายการโมเดลที่คัดสรรโดย OpenStudier
---
...
OpenStudier Zen คือรายการโมเดลที่ได้รับการทดสอบและตรวจสอบแล้วโดยทีมงาน OpenStudier

:::note
OpenStudier Zen ปัจจุบันอยู่ในช่วงเบต้า
:::

Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน OpenStudier คุณเข้าสู่ระบบ OpenStudier Zen และรับ
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่เลือกซึ่งทำงานได้ดีกับ OpenStudier
:::
...
OpenStudier Zen เป็นเกตเวย์ AI ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## มันทำงานอย่างไร

OpenStudier Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน OpenStudier

1. คุณลงชื่อเข้าใช้ **<a href={console}>OpenStudier Zen</a>** เพิ่มการเรียกเก็บเงินของคุณ
   รายละเอียดและคัดลอกรหัส API ของคุณ
2. คุณรันคำสั่ง `/connect` ใน TUI เลือก OpenStudier Zen และวางคีย์ API ของคุณ
...
[model id](/docs/config/#models) ในการกำหนดค่า OpenStudier ของคุณ
ใช้รูปแบบ `openstudier/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.2 Codex คุณจะต้อง
ใช้ `openstudier/gpt-5.2-codex` ในการกำหนดค่าของคุณ
...
- MiniMax M2.5 Free พร้อมใช้งานบน OpenStudier ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Big Pickle เป็นโมเดลล่องหนที่ให้บริการฟรีบน OpenStudier ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
...
เราสร้าง OpenStudier Zen เพื่อ:
...
4. **ไม่มีการล็อคอิน** โดยอนุญาตให้คุณใช้กับเอเจนต์การเขียนโค้ดอื่นๆ และให้คุณใช้ผู้ให้บริการรายอื่นกับ OpenStudier ได้เช่นกัน
