...
`.openstudier/commands/test.md` oluştur:
...
openstudier işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

openstudier [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/openstudier/commands/`
- Proje başına: `.openstudier/commands/`
...
openstudier, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
