---
title: Özel Araçlar
description: LLM'un openstudier'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. openstudier'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.openstudier/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/openstudier/tools/` içine yerleştirerek.
