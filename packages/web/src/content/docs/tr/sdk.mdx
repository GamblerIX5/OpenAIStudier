---
title: SDK
description: openstudier sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

openstudier JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
openstudier'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir openstudier örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `openstudier.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir openstudier örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
