---
title: Zen
description: Curated list of models provided by OpenStudier.
---
...
OpenStudier Zen is a list of tested and verified models provided by the OpenStudier team.

:::note
OpenStudier Zen is currently in beta.
:::

Zen works like any other provider in OpenStudier. You login to OpenStudier Zen and get
...
:::tip
We tested a select group of models and providers that work well with OpenStudier.
:::
...
OpenStudier Zen is an AI gateway that gives you access to these models.

---

## How it works

OpenStudier Zen works like any other provider in OpenStudier.

1. You sign in to **<a href={console}>OpenStudier Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select OpenStudier Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your OpenStudier config
uses the format `openstudier/<model-id>`. For example, for GPT 5.3 Codex, you would
use `openstudier/gpt-5.3-codex` in your config.
...
- MiniMax M2.5 Free is available on OpenStudier for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo V2 Flash Free is available on OpenStudier for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on OpenStudier for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on OpenStudier for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with OpenStudier as well.
