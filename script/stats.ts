...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/GamblerIX/OpenStudier/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for GamblerIX/OpenStudier...\n")
...
console.log("Fetching npm all-time downloads for openstudier...\n")
const npmDownloads = await fetchNpmDownloads("openstudier")
